    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Notice of Award</h4>
                <button type="submit" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                
            </div>
            <form  method="POST" enctype="multipart/form-data" id="AddAwardForm" class="form-horizontal" >
                @csrf
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="add_Award_btn"class="add_Award btn btn-primary">
...
<div id="editAwardModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Notice of Award</h4>
                <button type="submit" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                
            </div>
            <form  method="POST" enctype="multipart/form-data" id="editAwardForm" class="form-horizontal" >
              @method('PATCH')
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="edit_Award_btn"class="edit_Award btn btn-primary">
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="card">
                  ...
                  <a href="#" class="btn btn-lg btn-success" role="button" data-bs-toggle="modal" data-bs-target="#AddAwardModal">Add Notice of Award</a> <br /><br />
                  ...
                  <div class=" card-body p-0" id="datatable">
                      ...
                      <table class="table table-sm " id="table">
                          ...
                          <tbody>
                            @include('bac.award.partials.form')
                          </tbody>
                      </table>
...
<script>
    $(document).ready(function(){
        ...
        function fetch_data(page, sort_type, sort_by, search="") { 
            $.ajax({
            url: '{{ route('award.create') }}?page='+page+'&sortby='+sort_by+'&sorttype='+sort_type+'&search='+search,
            ...
            $("#AddAwardForm").submit(function(e) {
                    ...
                    $.ajax({
                      ...
                      success: function(response) {
                        ...
                        $("#add_Award_btn").text('Add Timeline');
      ...
      $(document).on('click', '.editIcon', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#edit_pdf").html(
              `<iframe src="/bac/award/${response.file}" width="100" class="img-fluid img-thumbnail" > </iframe>`);
            $("#id").val(response.id);
      ...
      $("#editAwardForm").submit(function(e) {
        ...
        const fd = new FormData(this);
        $.ajax({
          url: '{{ route('award.update','$awards->id') }}',
          method: "POST",
          data: fd,
          cache: false,
          contentType: false,
          ...
          success: function(response) {
            ...
            $("#edit_Award_btn").text('Update Award');
      ...
      $(document).on('click', '.deleteIcon', function(e) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '{{ route('award.destroy','$data->id') }}',
              method: 'delete',
              data: {
                id: id,
                _token: csrf
