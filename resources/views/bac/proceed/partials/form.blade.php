...
<tr>
    ...
    <td class="project-actions text-left">
        ...
        <a class="editIcon btn btn-info btn-sm " id="{{ $data->id }}" data-bs-toggle="modal" data-bs-target="#editProceedModal"><i class="fas fa-pencil-alt"></i> Edit </a>
        <a class="btn btn-sm btn-danger deleteIcon" id="{{ $data->id }}" ><i class="fas fa-trash"></i> Delete </a></td>            
</tr>   
@endforeach
<tr class="invitation_page_link">
<td colspan="6" align="right">{{ $proceeds->links() }}</td>
</tr>

{{-- <div class="col-md-14">
  <div class="card card-outline card-primary">
    <br />
    <p class="login-box-msg">Add a new Notice to Proceed</p>
