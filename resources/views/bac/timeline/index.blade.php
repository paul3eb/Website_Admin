...
<div id="AddTimelineModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form  method="POST" enctype="multipart/form-data" id="AddTimelineForm" class="form-horizontal" >
                @csrf
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="add_Timeline_btn"class="add_Timeline btn btn-primary">
...
<div id="editTimelineModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form  method="POST" enctype="multipart/form-data" id="editTimelineForm" class="form-horizontal" >
              @method('PATCH')
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="edit_Timeline_btn"class="edit_Timeline btn btn-primary">
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="card">
                  ...
                  <a href="#" class="btn btn-lg btn-success" role="button" data-bs-toggle="modal" data-bs-target="#AddTimelineModal">Add Timeline</a> <br /><br />
                      ...
                      <table class="table table-sm " id="table">
                          <thead>
                              <tr>
                                ...
                                <th class="sorting" data-sorting_type="desc" data-column_name="id" style="cursor:pointer">Date Posted
                          ...
                          <tbody>
                            @include('bac.timeline.partials.form')
                          </tbody>
                      </table>
...
<script>
    $(document).ready(function(){
        ...
        function fetch_data(page, sort_type, sort_by, search="") { 
            $.ajax({
            url: '{{ route('timeline.create') }}?page='+page+'&sortby='+sort_by+'&sorttype='+sort_type+'&search='+search,
            ...
            $("#AddTimelineForm").submit(function(e) {
                    ...
                    $.ajax({
                      ...
                      success: function(response) {
                        ...
                        $("#add_Timeline_btn").text('Add Timeline');
                        $("#AddTimelineForm")[0].reset();
      ...
      $(document).on('click', '.editIcon', function(e) {
        ...
        var id = $(this).attr('id');
        $.ajax({
          url: '{{ route('timeline.edit','$data->id') }}',
          method: 'get',
          data: {
            id: id,
            _token: '{{ csrf_token() }}'
          ...
          success: function(response) {
            ...
            $("#edit_pdf").html(
              `<iframe src="/bac/timeline/${response.file}" width="100" class="img-fluid img-thumbnail" > </iframe>`);
            $("#id").val(response.id);
      ...
      $("#editTimelineForm").submit(function(e) {
        e.preventDefault();
        var column_name = $('#hidden_column_name').val();
        var sort_type = $('#hidden_sort_type').val();
        var page = $('#hidden_page').val();
        const fd = new FormData(this);
        $.ajax({
          url: '{{ route('timeline.update','$timeline->id') }}',
          method: "POST",
          data: fd,
          cache: false,
          contentType: false,
          ...
          success: function(response) {
            ...
            $("#edit_Timeline_btn").text('Update Timeline');
            $("#editTimelineForm")[0].reset();
      ...
      $(document).on('click', '.deleteIcon', function(e) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '{{ route('timeline.destroy','$data->id') }}',
              method: 'delete',
              data: {
                id: id,
                _token: csrf
