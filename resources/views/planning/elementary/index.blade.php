        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="card">
                  ...
                  <a href="{{ route('elementary.create') }}" class="btn btn-lg btn-success" role="button">Add Elementary School</a>
                  </div>
                              ...
                              {{-- @foreach($users as $user) --}}
                                  <tr>
                                      ...
                                      <td class="project-actions text-left">
                                          ...
                                          <a class="btn btn-info btn-sm" href="{{ route('elementary.create') }}">
